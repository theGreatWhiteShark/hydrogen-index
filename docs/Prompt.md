...
Code generation about the same time as with Claude. Although I did not measure
since time is not the metric of concern in here.
...
```
{
  ...
  "presets": {
    "google": {
      "orchestrator": { "model": "github-copilot/gemini-3.1-pro-preview", "variant": "high", "skills": ["*"], "mcps": ["websearch"] },
      "oracle": { "model": "github-copilot/gemini-3.1-pro-preview", "variant": "high", "skills": [], "mcps": [] },
      "librarian": { "model": "github-copilot/gemini-3-flash-preview", "variant": "low", "skills": [], "mcps": ["websearch", "context7", "grep_app"] },
      "explorer": { "model": "github-copilot/gemini-3-flash-preview", "variant": "low", "skills": [], "mcps": [] },
      "designer": { "model": "github-copilot/gemini-3-flash-preview", "variant": "medium", "skills": ["agent-browser"], "mcps": [] },
