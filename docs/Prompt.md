...
Code generation took significantly more time than with Claude. Altough I did not
measure since time is not the metric of concern in here.
...
```
{
  ...
  "presets": {
    "openai": {
      ...
      "oracle": { "model": "github-copilot/gpt-5.4", "variant": "high", "skills": [], "mcps": [] },
      ...
      "designer": { "model": "github-copilot/gpt-5.4-mini", "variant": "medium", "skills": ["agent-browser"], "mcps": [] },
